...
expr_name=$1 #exp1, exp2, exp3
dataset=$2 #tvsum, summe
data_file=$3 # h5 file name

exp_path="$base_path/$expr_name"; echo $exp_path
...
python evaluation/compute_fscores.py --path $results_path --expr_name $expr_name --data_file $data_file --dataset $dataset
